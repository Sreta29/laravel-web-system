        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <form action="{{ route('configuration.category.index') }}" method="GET">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="{{ route('configuration.category.create') }}">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">{{ $cat->code }}</td>
                            ...
                            <div class="flex items-center space-x-4">
                              <a href="{{ route('configuration.category.edit', $cat->id) }}">
                                ...
                                <form method="POST" action="{{ route('configuration.category.delete', $cat->id) }}" onsubmit="return confirm('Are you sure you want to delete this item?')">
                                    @csrf
                                    @method('DELETE')
