                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Subcategory Name</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $subcategory->name}}</td>
                                <td class="px-4 py-3">{{ $subcategory->status}} </td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                <div class="flex items-center space-x-4">
                                <a href="{{ route('subcategories.edit') }}">
                                    ...
                                    <form method="POST" action="{{ route('subcategories.delete') }}" onsubmit="return confirm('Are you sure you want to delete this item?')">
                                        @csrf
                                        @method('DELETE')
