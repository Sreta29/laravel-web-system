...
<section class="w-full bg-white dark:bg-gray-900">
    <div class="w-full px-4 py-8 mx-auto lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add New SubCategory</h2>
        <div class="p-2">
        ...
        <form method="post" action="{{ route('subcategories.store', $category) }}" enctype="multipart/form-data">
            @csrf
